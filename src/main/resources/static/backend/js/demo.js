...
$(function() {
	...
	function revisar() {
		$.ajax({
			url : '/api/comunicado/revisar',
			dataType : "json",
			async : true,
			success : function(resultado) {
				if (resultado.alertas <= 0) {
					$('#menu-alertas').css("display", "none");
					$('#alertas-icono').css("display", "none");
				} else {
					$('#alertas-icono').css("display", "inherit");
					$('#alertas-icono').html(resultado.alertas);

					$('#menu-alertas').css("display", "inherit");
					$('#menu-alertas').html(resultado.alertas);

				}

				if (resultado.comunicados <= 0) {
					$('#menu-comunicados').css("display", "none");
					$('#comunicados-icono').css("display", "none");
				} else {
					$('#comunicados-icono').css("display", "inherit");
					$('#comunicados-icono').html(resultado.comunicados);

					$('#menu-comunicados').css("display", "inherit");
					$('#menu-comunicados').html(resultado.comunicados);
				}

				if (resultado.eventos <= 0) {
					$('#menu-eventos').css("display", "none");
					$('#eventos-icono').css("display", "none");
				} else {
					$('#eventos-icono').css("display", "inherit");
					$('#eventos-icono').html(resultado.eventos);

					$('#menu-eventos').css("display", "inherit");
					$('#menu-eventos').html(resultado.eventos);

				}

				if (resultado.encuestas <= 0) {
					$('#menu-encuestas').css("display", "none");
					$('#encuestas-icono').css("display", "none");
				} else {
					$('#encuestas-icono').css("display", "inherit");
					$('#encuestas-icono').html(resultado.encuestas);

					$('#menu-encuestas').css("display", "inherit");
					$('#menu-encuestas').html(resultado.encuestas);
